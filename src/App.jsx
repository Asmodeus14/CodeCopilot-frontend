  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-dark-900 via-dark-950 to-black">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        ...
        <div
          className="absolute -bottom-40 -left-40 w-80 h-80 bg-purple-500 rounded-full blur-3xl opacity-10 animate-float"
      ...
      <footer className="relative z-10 text-center py-12">
        <div className="border-t border-dark-700/50 pt-8">
          ...
          <div className="flex items-center justify-center space-x-6">
            <a
              href="https://github.com/Asmodeus14/CodeCopilot-frontend"
              target="_blank"
          ...
          <p className="text-gray-500 text-sm mt-4 font-light">
            Open Source • Secure • Privacy Focused
          </p>
        </div>
      </footer>
